  ...
  if (locked) {
    return (
      <GlassCard strong className="mx-auto max-w-lg text-center">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-50 ring-0">
  ...
  return (
    <GlassCard strong className="flex h-[70vh] flex-col">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto pr-1">
        ...
        {loading && (
          <div className="flex justify-start">
            <div className="border border-gray-100 bg-gray-50 rounded-2xl px-4 py-3">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {SUGGESTIONS.map((s) => (
            <button
              key={s}
              onClick={() => send(s)}
              className="rounded-full border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs text-muted-foreground transition-colors hover:bg-gray-100 hover:text-foreground"
            >
              {s}
            </button>
          ))}
      ...
      <form
        ...
        className="mt-3 flex items-center gap-2 rounded-xl border border-gray-100 bg-gray-50 px-3 py-2"
      >
        <input
          value={input}
        ...
        <button
          ...
          className="rounded-lg bg-gradient-to-br from-brand-500 to-brand-700 p-2 disabled:opacity-50"
        >
