...
function LoginForm() {
  ...
  return (
    <GlassCard strong>
      ...
      <p className="mt-1 text-sm text-muted-foreground">Log in to your Goalify account.</p>
      ...
      <form action={action} className="mt-6 space-y-4">
        ...
        <div className="flex justify-end">
          <Link href="/forgot-password" className="text-sm text-accent-purple hover:underline">
            Forgot password?
          </Link>
        </div>
