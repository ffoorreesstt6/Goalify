    ...
    <section className="relative py-28">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-purple-700 p-12 text-center shadow-glow-lg sm:p-16"
        >
          ...
          <div className="relative mt-8 flex justify-center">
            <Link
              href="/signup"
              className="group inline-flex items-center gap-2 rounded-xl bg-white px-7 py-3.5 font-semibold text-purple-700 transition-transform hover:scale-105"
            >
              Start for free
